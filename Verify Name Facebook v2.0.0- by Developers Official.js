// ==UserScript==
// @name         Verify Name Facebook v2.0.0
...
(function() {
    ...
    function saveSettings() {
        GM_setValue('targetClass', document.getElementById('classInput').value);
        GM_setValue('newHtml', document.getElementById('htmlInput').value);
        GM_setValue('customName', document.getElementById('nameInput').value);
        GM_setValue('customNickname', document.getElementById('nicknameInput').value);
        GM_setValue('customNicknameEnabled', customNicknameEnabled);
        GM_setValue('alwaysSave', document.getElementById('saveInput').checked);
